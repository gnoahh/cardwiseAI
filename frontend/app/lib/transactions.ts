...
export const CATEGORY_META = {
  ...
  transit: { label: "Transit", color: "#60a5fa", icon: "🚇" },
...
export const MOCK_TRANSACTIONS: Transaction[] = [
  ...
  { id: "t3",  date: "2026-03-27", merchant: "MTA NYC Transit",     amount: 33.00,  category: "transit",       icon: "🚇" },
  ...
  { id: "t18", date: "2026-03-19", merchant: "MTA NYC Transit",     amount: 33.00,  category: "transit",       icon: "🚇" },
  ...
  { id: "t37", date: "2026-03-05", merchant: "MTA NYC Transit",     amount: 33.00,  category: "transit",       icon: "🚇" },
...
export const CATEGORY_TO_CARD_RATE: Record<CategoryKey, string[]> = {
  ...
  transit:       ["transit", "travel_other", "other"],
  gas:           ["gas"],
